...
@task()
def push_course_update_task(course_key_string, course_channel_id, course_display_name):
    """
    ...
    send_push_course_update(course_key_string, course_channel_id, course_display_name)
